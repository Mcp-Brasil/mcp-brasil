...
Adicione o bloco abaixo ao seu arquivo `mcp_config.json` (acessível no Antigravity em **MCP Servers -> View raw config** ou localizado em `~/.gemini/antigravity/mcp_config.json`):
